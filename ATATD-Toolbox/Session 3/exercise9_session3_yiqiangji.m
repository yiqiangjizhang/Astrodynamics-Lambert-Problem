...
mu_Earth = getAstroConstants('Earth', 'mu'); % [km3/s2]
mu_Mars = getAstroConstants('Mars', 'mu'); % [km3/s2]

R_Earth = getAstroConstants('Earth', 'Radius'); % [km]
R_Mars = getAstroConstants('Mars', 'Radius'); % [km]
