...
date_dep_Earth = [2016, 1, 9, 0, 0, 0];
date_arr_Mars = [2016, 11, 19, 0, 0, 0];
...
[rf_trans_real, rf_dot_trans_real, delta_E, F, G] = FGKepler_dt(mu, r_dep_Earth, r1_dot, delta_t_target);
error = norm(rf_trans_real - r_arr_Mars);

[STM] = STM_Lambert(mu, rf_trans_real, delta_E, F, G, r_dep_Earth, r1_dot, delta_t_target);
