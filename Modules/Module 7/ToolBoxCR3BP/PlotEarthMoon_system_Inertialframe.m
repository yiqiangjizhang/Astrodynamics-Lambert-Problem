%% PlotEarthMoon_system_frame.m
xSun = -mu;
xEarth = 1-mu;
% 2. Plot Axes
scale = 1/UnitDistance;
...
hold(axes1,'all');
%--------------------------------------------------------------------------
[hfig] = drawPlanet('Earth',[0 0 0],figure1,scale*4);
...
%--------------------------------------------------------------------------
[x,y,z]=cylinder(1-mu,100);
plot3(x(1,:)',y(1,:)',z(1,:)','LineWidth',1,'Color',[0 0 0])